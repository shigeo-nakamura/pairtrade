//! Optional S3 mirror for status / ledger files (bot-strategy#343).
//!
//! Shared by every runtime in this crate (`engine_b_live`, `book-runtime`,
//! ...); it used to live under the now-removed `pairtrade` module tree.
//!
